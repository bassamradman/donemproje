...
<body >
			 ...
			 <div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav ml-auto ">
					...
					<li class="nav-item">
	      			...
	      			<li class="nav-item">
						<a href="sana.html" class="nav-link active ">
	      				sana
	      				</a>
					</li>	
					...
					<li class="nav-item dropdown active ">
					  ...
					  <div class="dropdown-menu ">
					    <a class="dropdown-item" href="ebubekir.html">ebubekir salim</a>
	...
	<div class="container">
				<form  action="loginkontrol.php" name="Form" onsubmit="return control()" method="POST">
				<div class="form-group">
					<label for="isim">Kullanıcı Adı</label>
					<input type="text" name="email" class="form-control" placeholder="Kullanıcı Adını girin.(b191210002@sakarya.edu.tr)">
					<small class="form-text text-muted">Zorunlu alan</small>
				</div>
				
				<div class="form-group">
					<label for="sifre">Şifre</label>
					<input type="password" name="sifre" class="form-control" placeholder="Şireyi girin(b191210002)">							
					<small class="form-text text-muted">Zorunlu alan</small>
				</div>
				<button class="btn" type="reset" id="submit" name="submit" value="Reset" onclick="check()">Temizle</button>
				<button class="btn " type="submit" id="sub">Gönder</button>
				<br><br><br>
	...
	<footer class="py-3 bg-danger text-white text-center">
		Web-Teknolojileri-Projesi © Bassam Radman 2022
	</footer>
	
	<script>
		function control()
		{
			var soyadi = document.forms["Form"]["sifre"].value;
			if (soyadi == "") 
			{
